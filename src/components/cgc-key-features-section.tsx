...
const row1Features: Feature[] = [
  {
    ...
    description:
      "Complete site preparation including excavation, grading, compaction, and drainage — transforming raw land into construction-ready sites.",
  },
  {
    id: 2,
    icon: Building2,
    ...
    description:
      "Reinforced concrete and steel structural design and construction — engineered for strength, durability, and seismic compliance.",
  },
  {
    id: 3,
    icon: Hammer,
    ...
    description:
      "Expert concrete pouring, steel fabrication, rebar installation, and formwork — delivered with precision and strict quality control.",
  },
  {
    id: 4,
    icon: Route,
    ...
    description:
      "Road construction, utility networks, drainage systems, and landscaping — building the infrastructure that connects communities.",
  },
];
...
const row2Features: Feature[] = [
  {
    ...
    description:
      "Complete interior finishing including flooring, painting, ceiling systems, and joinery — transforming structures into functional spaces.",
  },
  {
    id: 6,
    icon: RefreshCw,
    ...
    description:
      "Building renovation, structural repair, facade restoration, and modernization — breathing new life into existing structures.",
  },
  {
    id: 7,
    icon: ShieldCheck,
    ...
    description:
      "Rigorous quality control, safety management, and compliance with Saudi building codes and international construction standards.",
  },
];
...
export function CGCKeyFeaturesSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            Everything you need to plan, build, and deliver world-class
            construction projects — from a single trusted partner.
          </p>
        </div>
