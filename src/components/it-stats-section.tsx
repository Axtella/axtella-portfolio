...
import { ArrowUpCircle, Users, Clock, TrendingDown, Zap } from "lucide-react";
...
const stats: StatCard[] = [
  {
    ...
    description:
      "Enterprise-grade infrastructure with redundant systems, load balancing, and 24/7 monitoring ensures maximum availability.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Trusted by over 50 enterprises across banking, healthcare, government, and energy sectors in Saudi Arabia.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    description:
      "Round-the-clock NOC monitoring, dedicated helpdesk, and rapid incident response — your IT never sleeps.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    suffix: "%",
    displayValue: "70%",
    title: "Cost Reduction via Cloud",
    description:
      "Cloud migration and optimization strategies that dramatically reduce IT infrastructure costs while improving performance.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 70,
  },
  {
    ...
    description:
      "Guaranteed rapid response with automated alerts, escalation protocols, and on-call engineering teams ready 24/7.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 90,
  },
...
export function ITStatsSection() {
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real deployments — here&apos;s what our IT
