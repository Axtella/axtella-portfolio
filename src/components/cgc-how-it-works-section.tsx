...
const steps: Step[] = [
  {
    ...
    description:
      "We conduct topographic surveys, soil testing, feasibility studies, and detailed project planning — ensuring every project starts on solid ground.",
  ...
  },
  {
    ...
    description:
      "Our engineers create structural designs, coordinate with architects, prepare material specifications, and develop comprehensive BOQ documentation.",
  ...
  },
  {
    ...
    description:
      "Foundation works, structural framing, concrete pouring, and systematic construction phases — executed with precision and strict timeline adherence.",
  ...
  },
  {
    ...
    description:
      "Material testing, structural integrity checks, code compliance verification, and thorough punch-list resolution — ensuring every detail meets specifications.",
  ...
  },
  {
    ...
    description:
      "Final inspection, as-built documentation, warranty support, and post-construction maintenance — ensuring a smooth transition to operations.",
    image: "/images/fleet/fleet15.png",
  },
];

export function CGCHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            From Blueprint to Handover in 5 Steps
          </h2>
          ...
          >
            We handle everything — from initial site survey to final handover
