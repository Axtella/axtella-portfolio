...
const steps: Step[] = [
  {
    ...
    icon: ClipboardList,
    emoji: "🏢",
    title: "Building Assessment & Audit",
    description:
      "We evaluate your building's existing systems, infrastructure, and energy profile to identify automation opportunities and define project scope.",
  ...
  },
  {
    ...
    description:
      "Our engineers design a tailored BMS architecture — selecting controllers, sensors, protocols, and integration points for maximum efficiency.",
    image: "/images/fleet/fleet1.png",
  },
  {
    number: "03",
    ...
    description:
      "Professional installation of BMS hardware, wiring, and software with seamless integration into existing HVAC, lighting, fire, and security systems.",
    image: "/images/fleet/fleet1.png",
  },
  {
    number: "04",
    ...
    description:
      "Rigorous end-to-end testing of all automation sequences, fail-safes, alarm routing, and energy optimization logic before handover.",
    image: "/images/fleet/fleet1.png",
  },
  {
    number: "05",
    ...
    description:
      "24/7 remote monitoring, preventive maintenance, software updates, and dedicated support to keep your building running at peak performance.",
    image: "/images/fleet/fleet1.png",
  },
];

export function BMSHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            We handle everything — from initial building assessment to 24/7
