...
const industries: Industry[] = [
  {
    ...
    tagline: "Secure, compliant, and scalable IT for financial institutions",
    features: [
  ...
  },
  {
    ...
    icon: Heart,
    title: "Healthcare",
    tagline: "HIPAA-ready IT infrastructure for hospitals and clinics",
    features: [
      "Electronic health record systems",
      "Telemedicine platform setup",
      "Medical data security & backup",
    ],
  ...
  },
  {
    ...
    icon: Landmark,
    title: "Government",
    tagline: "Sovereign cloud and e-government solutions",
    features: [
  ...
  },
  {
    ...
    tagline: "Omnichannel technology for modern retail",
    features: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    title: "Education",
    tagline: "Digital learning infrastructure for schools and universities",
    features: [
  ...
  },
  {
    ...
    icon: Zap,
    title: "Oil & Energy",
    tagline: "Industrial-grade IT for energy sector operations",
    features: [
...
export function ITIndustriesSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          ...
          <div ref={headerRef}>
            ...
            >
              From banking to energy — we deliver specialized IT solutions
