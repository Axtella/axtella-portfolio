...
export function ELVOffersSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[35%] lg:sticky lg:top-32 flex-shrink-0">
            ...
            >
              Comprehensive Extra Low Voltage solutions from CCTV surveillance
              and access control to fire alarm systems and structured cabling
              — trusted by facilities across Saudi Arabia.
            </p>
