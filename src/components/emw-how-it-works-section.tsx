...
const steps: Step[] = [
  {
    ...
    description:
      "We evaluate site conditions, assess mechanical and electrical load requirements, review existing infrastructure, and ensure full regulatory compliance before any work begins.",
  ...
  },
  {
    ...
    description:
      "Our engineers create detailed MEP drawings, equipment specifications, bill of quantities, and coordination plans — ensuring every system works together seamlessly.",
  ...
  },
  {
    ...
    description:
      "We source quality equipment from trusted manufacturers, manage fabrication and logistics, and execute professional installation with strict quality control.",
  ...
  },
  {
    ...
    description:
      "Comprehensive system testing, load balancing, performance verification, and third-party certification — ensuring every system meets design specifications.",
  ...
  },
  {
    ...
    description:
      "Preventive maintenance programs, 24/7 emergency response, performance monitoring, and continuous optimization to maximize system lifespan.",
    image: "/images/fleet/fleet15.png",
  },
];

export function EMWHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            From Design to Commissioning in 5 Steps
          </h2>
          ...
          >
            We handle everything — from initial site assessment to ongoing
