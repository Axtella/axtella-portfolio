...
const offerCards = [
  ...
  {
    id: 7,
    title: "Smart Environment Solutions",
    icon: "🌿",
    image: "/images/fleet/fleet7.png",
  },
];

export function IoTOffersSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[35%] lg:sticky lg:top-32 flex-shrink-0">
            ...
            >
              End-to-end IoT solutions from sensor deployment and edge computing
              to cloud analytics and device management — trusted by businesses
              across Saudi Arabia.
            </p>
