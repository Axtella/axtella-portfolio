...
const stats: StatCard[] = [
  {
    ...
    description:
      "Carrier-grade infrastructure with redundant paths, automatic failover, and 24/7 NOC monitoring ensures maximum network availability.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    suffix: "+",
    displayValue: "500+",
    title: "Km Fiber Deployed",
    description:
      "Over 500 kilometers of fiber optic cable installed across Saudi Arabia — connecting cities, campuses, and enterprises.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    description:
      "Round-the-clock Network Operations Center with real-time fault detection, automated alerts, and rapid incident resolution.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    description:
      "Trusted by over 50 enterprise clients across government, banking, healthcare, and energy sectors for mission-critical connectivity.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 75,
  },
  {
    ...
    description:
      "Guaranteed rapid response with on-call field engineers, spare equipment pools, and escalation protocols for critical network issues.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 85,
  },
