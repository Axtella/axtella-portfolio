...
import { Award, Clock, Ruler, Calendar, ShieldCheck } from "lucide-react";
...
const stats: StatCard[] = [
  {
    ...
    description:
      "Successfully delivered construction projects across commercial, industrial, and residential sectors throughout Saudi Arabia.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Industry-leading project completion rate — powered by meticulous planning, resource management, and experienced site teams.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    title: "Sq.M Built",
    description:
      "Over half a million square meters of construction completed — from commercial towers to industrial facilities and residential compounds.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    description:
      "Two decades of civil engineering and construction expertise — building the Kingdom's most demanding infrastructure projects.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 80,
  },
  {
    ...
    description:
      "Perfect safety record across all active sites — achieved through rigorous protocols, continuous training, and zero-tolerance safety culture.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 100,
  },
...
export function CGCStatsSection() {
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real projects — here&apos;s what our civil
            engineering and construction team delivers across Saudi Arabia.
          </p>
        </div>
