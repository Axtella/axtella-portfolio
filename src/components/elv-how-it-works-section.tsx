...
const steps: Step[] = [
  {
    ...
    description:
      "Our engineers conduct a thorough site survey, assess your security and communication requirements, and identify the optimal ELV system design for your facility.",
  ...
  },
  {
    ...
    description:
      "We create detailed system architecture, equipment specifications, cable routing plans, and integration schematics \u2014 all compliant with local and international standards.",
  ...
  },
  {
    ...
    description:
      "Professional installation of all ELV equipment, structured cabling, conduit routing, termination, and labeling \u2014 with minimal disruption to your ongoing operations.",
  ...
  },
  {
    ...
    description:
      "Comprehensive system testing including camera coverage verification, access point validation, fire alarm loop testing, and PA intelligibility assessment.",
  ...
  },
  {
    ...
    description:
      "Scheduled preventive maintenance, 24/7 remote monitoring, rapid on-site support, firmware updates, and system health reporting to ensure continuous operation.",
    image: "/images/fleet/fleet15.png",
  },
];

export function ELVHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            From Survey to Support in 5 Steps
          </h2>
          ...
          >
            We handle everything — from initial site survey to ongoing maintenance
