...
import { Award, Clock, Headphones, Calendar, ShieldCheck } from "lucide-react";
...
const stats: StatCard[] = [
  {
    ...
    description:
      "Successfully completed MEP projects across commercial, industrial, and residential sectors throughout Saudi Arabia.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Industry-leading project delivery rate — powered by meticulous planning, coordination, and experienced execution teams.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    description:
      "Round-the-clock emergency response for critical MEP systems — minimizing downtime and protecting your operations.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    description:
      "Over a decade of MEP engineering expertise — delivering reliable infrastructure for the Kingdom's most demanding projects.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 60,
  },
  {
    ...
    title: "Safety Record",
    description:
      "Zero major safety incidents across all projects — achieved through rigorous safety protocols and continuous training programs.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 100,
  },
...
export function EMWStatsSection() {
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real projects — here&apos;s what our
            electro-mechanical engineering team delivers for businesses across
            Saudi Arabia.
          </p>
        </div>
