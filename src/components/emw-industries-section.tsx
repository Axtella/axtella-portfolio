...
const industries: Industry[] = [
  {
    ...
    tagline: "Office towers, retail centers, and mixed-use developments",
    features: [
      "Central HVAC & chiller plant systems",
  ...
  },
  {
    ...
    tagline: "Hospitals, clinics, and medical centers",
    features: [
  ...
  },
  {
    ...
    tagline: "Production facilities, warehouses, and cold storage",
    features: [
      "Industrial ventilation & exhaust",
      "Heavy-duty electrical distribution",
      "Process piping & drainage",
  ...
  },
  {
    ...
    icon: Hotel,
    title: "Hospitality",
    tagline: "Hotels, resorts, restaurants, and entertainment venues",
    features: [
      "Guest room HVAC & controls",
      "Kitchen ventilation & exhaust",
      "Hot water & laundry systems",
      "Pool & spa mechanical systems",
    ],
  ...
  },
  {
    ...
    tagline: "Government buildings, airports, and public infrastructure",
    features: [
      "Large-scale HVAC systems",
      "Standby power generation",
      "Public safety fire systems",
...
export function EMWIndustriesSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          ...
          <div ref={headerRef}>
            ...
            >
              MEP Solutions For Every Sector
            </h2>
            ...
            >
              From commercial towers to industrial facilities — we deliver
              specialized electro-mechanical solutions tailored to each
