...
const industries: Industry[] = [
  {
    ...
    tagline: "Integrated security and communication for modern offices",
    features: [
  ...
  },
  {
    ...
    tagline: "Life-safety and communication systems for hospitals",
    features: [
  ...
  },
  {
    ...
    tagline: "Smart campus security and PA systems",
    features: [
      "Campus-wide CCTV coverage",
  ...
  },
  {
    ...
    icon: Hotel,
    title: "Hospitality",
    tagline: "Guest safety and operational efficiency",
    features: [
  ...
  },
  {
    ...
    icon: ShoppingCart,
    title: "Retail & Malls",
    tagline: "Security and customer experience systems",
    features: [
      "Video analytics & loss prevention",
  ...
  },
  {
    ...
    tagline: "Heavy-duty ELV for manufacturing and warehouses",
    features: [
      "Explosion-proof CCTV systems",
      "Industrial intercom networks",
...
export function ELVIndustriesSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          ...
          <div ref={headerRef}>
            ...
            >
              ELV Solutions For Every Facility
            </h2>
            ...
            >
              From commercial towers to hospitals — we deliver specialized ELV
              systems tailored to the unique requirements of each facility type.
            </p>
          </div>
