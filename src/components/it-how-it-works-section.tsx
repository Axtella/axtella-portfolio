...
const steps: Step[] = [
  {
    ...
    description:
      "We evaluate your current infrastructure, identify security vulnerabilities, performance bottlenecks, and compliance gaps to build a clear roadmap for improvement.",
  ...
  },
  {
    ...
    description:
      "Our architects design a tailored IT strategy covering infrastructure, cloud, security, and software — aligned with your business goals and budget.",
  ...
  },
  {
    ...
    description:
      "We deploy infrastructure, migrate systems to the cloud, integrate enterprise software, and configure networks — all with minimal disruption to your operations.",
  ...
  },
  {
    ...
    description:
      "Comprehensive penetration testing, vulnerability scanning, compliance validation, and security hardening to ensure your systems are bulletproof.",
  ...
  },
  {
    ...
    description:
      "24/7 monitoring, proactive maintenance, regular security updates, performance tuning, and dedicated support to keep your IT running at peak efficiency.",
    image: "/images/fleet/fleet15.png",
  },
];

export function ITHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            We handle everything — from initial IT audit to 24/7 infrastructure
