...
import { Zap, ArrowUpCircle, Building2, Clock, Shield } from "lucide-react";
...
const stats: StatCard[] = [
  {
    ...
    description:
      "Average energy cost reduction achieved through intelligent automation",
    accentColor: "#22c55e",
  ...
  },
  {
    ...
    title: "System Uptime",
    description:
      "Guaranteed uptime with redundant controllers and 24/7 monitoring",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Smart buildings across Saudi Arabia operating on our BMS platform",
    accentColor: "#3B82F6",
  ...
  },
  {
    ...
    title: "Response Time",
    description:
      "Average alarm acknowledgment and first-response time",
    accentColor: "#8B5CF6",
  ...
  },
  {
    ...
    title: "Monitoring",
    description:
      "Round-the-clock remote monitoring and incident management",
    accentColor: "#EF4444",
...
export function BMSStatsSection() {
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real deployments — here&apos;s what our building
            management solutions deliver across Saudi Arabia.
          </p>
        </div>
