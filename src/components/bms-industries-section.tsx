...
const industries: Industry[] = [
  {
    ...
    tagline: "Create productive, energy-efficient workspaces",
    features: [
      "Zone-based HVAC & lighting control",
  ...
  },
  {
    ...
    tagline: "Maintain critical environments for patient safety",
    features: [
      "Precision temperature & humidity control",
      "Air quality & pressure monitoring",
  ...
  },
  {
    ...
    tagline: "Deliver guest comfort while optimizing costs",
    features: [
      "Room-level climate automation",
      "Guest presence-based controls",
  ...
  },
  {
    ...
    icon: ShoppingCart,
    title: "Retail & Malls",
    tagline: "Optimize large-scale environments for shoppers",
    features: [
      "Multi-zone HVAC scheduling",
  ...
  },
  {
    ...
    tagline: "Smart environments for learning institutions",
    features: [
      "Classroom comfort automation",
      "Campus-wide energy monitoring",
      "Scheduling-based system control",
    ],
    image: "/images/fleet/fleet1.png",
  },
  {
    ...
    tagline: "Reliable automation for manufacturing environments",
    features: [
...
export function BMSIndustriesSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          ...
          <div ref={headerRef}>
            ...
            >
              From commercial offices to industrial facilities — we deliver
              specialized BMS solutions tailored to the unique challenges of
              each sector.
            </p>
          </div>
