...
import { Truck, Code, BarChart3, Radio, Building, MapPin, Clock, ChevronDown } from "lucide-react";
...
const positions: Position[] = [
  { icon: Truck, title: "Fleet Solutions Engineer", department: "Engineering", location: "Riyadh", type: "Full-time" },
  { icon: Code, title: "React Developer", department: "IT", location: "India", type: "Full-time" },
  { icon: BarChart3, title: "Sales Manager - AVL", department: "Sales", location: "Riyadh", type: "Full-time" },
  { icon: Radio, title: "Telecom Field Technician", department: "Engineering", location: "Riyadh", type: "Contract" },
  { icon: Building, title: "Civil Project Manager", department: "Engineering", location: "Riyadh", type: "Full-time" },
];

const departmentFilters = ["All", "Engineering", "IT", "Sales"];
const locationFilters = ["All Locations", "Riyadh", "Bahrain", "India"];
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 ml-14 sm:ml-0">
                    ...
                    <a
                      href={`mailto:careers@axtellaglobal.com?subject=Application: ${pos.title}`}
