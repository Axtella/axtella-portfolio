...
import { Fuel, Timer, Shield, ClipboardCheck, Eye } from "lucide-react";
...
interface StatCard {
  icon: LucideIcon;
  targetNumber: number | null; // null for "24/7"
  prefix?: string;
  suffix: string;
  displayValue: string; // final display e.g. "20-30%"
  title: string;
  description: string;
  accentColor: string;
  accentBg: string;
...
const stats: StatCard[] = [
  {
    ...
    title: "Fuel Savings",
    description:
      "Reduce fuel waste through real-time monitoring, smart route optimization, and instant theft detection alerts.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    title: "Less Downtime",
    description:
      "Predictive maintenance powered by OBD diagnostics prevents breakdowns before they happen — keeping your fleet on the road.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    description:
      "Driver behavior monitoring, real-time speed alerts, and AI-powered safety scores reduce incidents dramatically.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    title: "Compliance",
    description:
      "Automated documentation, geofence logging, and reporting ensure full compliance with Saudi transport regulations.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 100,
  },
  {
    ...
    description:
      "Real-time tracking of every vehicle, asset, and driver in your fleet — from any device, anywhere, anytime.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 100,
  },
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real deployments — here&apos;s what our fleet
            management platform delivers for businesses across Saudi Arabia.
          </p>
        </div>
