...
const industries: Industry[] = [
  {
    ...
    tagline: "Secure, sovereign communication infrastructure",
    features: [
      "Encrypted communication networks",
      "National fiber backbone deployment",
  ...
  },
  {
    ...
    tagline: "Ultra-low latency connectivity for financial operations",
    features: [
      "Trading floor network infrastructure",
      "Branch-to-HQ secure connectivity",
  ...
  },
  {
    ...
    icon: Heart,
    title: "Healthcare",
    tagline: "Reliable connectivity for life-critical systems",
    features: [
      "Hospital campus networking",
      "Telemedicine infrastructure setup",
      "Emergency communication backbone",
    ],
  ...
  },
  {
    ...
    icon: GraduationCap,
    title: "Education",
    tagline: "Campus-wide connectivity for modern learning",
    features: [
      "University network infrastructure",
      "Smart classroom connectivity",
      "Research network high-bandwidth links",
    ],
  ...
  },
  {
    ...
    icon: Hotel,
    title: "Hospitality",
    tagline: "Seamless guest and operational connectivity",
    features: [
      "High-density guest Wi-Fi networks",
      "In-room communication systems",
      "Property-wide coverage solutions",
    ],
  ...
  },
  {
    ...
    icon: Zap,
    title: "Oil & Energy",
    tagline: "Industrial-grade connectivity for remote operations",
    features: [
      "Remote site satellite connectivity",
      "SCADA & industrial network setup",
