...
const industries: Industry[] = [
  {
    ...
    tagline: "Office towers, retail complexes, and mixed-use developments",
    features: [
  ...
  },
  {
    ...
    icon: Home,
    title: "Residential",
    tagline: "Villas, apartment buildings, and residential compounds",
    features: [
      "Villa and townhouse construction",
      "Multi-story apartment buildings",
      "Compound infrastructure works",
      "Landscape and hardscape finishing",
    ],
  ...
  },
  {
    ...
    icon: Factory,
    title: "Industrial",
    tagline: "Factories, warehouses, logistics centers, and industrial parks",
    features: [
  ...
  },
  {
    ...
    tagline: "Roads, bridges, utilities, and drainage systems",
    features: [
  ...
  },
  {
    ...
    tagline: "Hospitals, schools, universities, and research centers",
    features: [
      "Hospital building construction",
      "School and campus development",
      "Laboratory facility build-out",
  ...
  },
  {
    ...
    tagline: "Government buildings, public facilities, and civic structures",
    features: [
      "Government office complexes",
      "Public facility construction",
      "Monument and civic structures",
      "Security infrastructure works",
    ],
...
export function CGCIndustriesSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          ...
          <div ref={headerRef}>
            ...
            >
              Construction Solutions For Every Sector
            </h2>
            ...
            >
              From commercial towers to public infrastructure — we deliver
              specialized construction solutions tailored to each sector&apos;s
              requirements.
            </p>
          </div>
