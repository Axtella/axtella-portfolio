...
const offerCards = [
  ...
  {
    id: 6,
    title: "Custom Dashboards & Mobile App",
    icon: "📊",
...
export function FleetOffersSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[35%] lg:sticky lg:top-32 flex-shrink-0">
            ...
            >
              End-to-end AVL and fleet management solutions powered by GPS, IoT,
              and cloud technology for fleet operators across Saudi Arabia.
            </p>
