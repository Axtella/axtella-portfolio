...
import { Cpu, ArrowUpCircle, TrendingUp, Zap, Clock } from "lucide-react";
...
const stats: StatCard[] = [
  {
    ...
    description:
      "Over 10,000 IoT sensors and devices deployed across industrial, commercial, and environmental monitoring networks.",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade IoT infrastructure with redundant gateways, failover protocols, and 24/7 network monitoring.",
    accentColor: "#1B7FE0",
  ...
  },
  {
    ...
    description:
      "IoT-driven automation and predictive analytics that dramatically improve operational efficiency and reduce waste.",
    accentColor: "#10B981",
  ...
  },
  {
    ...
    title: "Data Latency",
    description:
      "Near real-time data processing with edge computing and optimized communication protocols for instant insights.",
    accentColor: "#F59E0B",
    accentBg: "rgba(245,158,11,0.15)",
    progressPercent: 95,
  },
  {
    ...
    description:
      "Round-the-clock IoT device health monitoring, automated alerts, and remote diagnostics for your entire fleet.",
    accentColor: "#1B7FE0",
    accentBg: "rgba(27,127,224,0.15)",
    progressPercent: 100,
  },
...
export function IoTStatsSection() {
    ...
    >
      ...
      >
        ...
        <div ref={headerRef} className="text-center mb-12 lg:mb-16">
          ...
          >
            Real impact from real deployments — here&apos;s what our IoT
