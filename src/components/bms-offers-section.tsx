...
const offerCards = [
  {
    ...
    description:
      "Intelligent heating, ventilation, and air conditioning control for optimal indoor comfort and energy efficiency.",
  },
  {
    id: 2,
    ...
    image: "/images/fleet/fleet1.png",
    description:
      "Smart lighting management with occupancy sensing, daylight harvesting, and scheduled control zones.",
  },
  {
    id: 3,
    ...
    image: "/images/fleet/fleet1.png",
    description:
      "Real-time energy monitoring, demand optimization, and automated load balancing to reduce operational costs.",
  },
  {
    id: 4,
    ...
    image: "/images/fleet/fleet1.png",
    description:
      "Integrated fire detection, alarm management, and emergency response coordination systems.",
  },
  {
    id: 5,
    ...
    image: "/images/fleet/fleet1.png",
    description:
      "Unified access management with biometric readers, card systems, and CCTV integration.",
  },
  {
    id: 6,
    title: "Building Analytics & Reporting",
    icon: "📊",
    image: "/images/fleet/fleet1.png",
    description:
      "Comprehensive dashboards with real-time KPIs, historical trends, and predictive insights.",
  },
  {
    id: 7,
    ...
    image: "/images/fleet/fleet1.png",
    description:
      "Seamless connection of environmental sensors, smart meters, and IoT devices into a single platform.",
  },
];

export function BMSOffersSection() {
      ...
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[35%] lg:sticky lg:top-32 flex-shrink-0">
            ...
            >
              Comprehensive BMS & Smart Building Solutions
            </p>
            ...
            >
              From HVAC automation and energy management to fire safety and IoT
              integration — we deliver end-to-end Building Management Systems
              that make your facilities smarter, safer, and more efficient.
            </p>
