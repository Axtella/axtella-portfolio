...
const steps: Step[] = [
  {
    ...
    description:
      "We evaluate your infrastructure, connectivity, and data needs to identify the best IoT use cases and create a deployment roadmap tailored to your operations.",
  ...
  },
  {
    ...
    description:
      "Our engineers design the IoT ecosystem — selecting sensors, gateways, communication protocols, and cloud platforms to match your performance and budget requirements.",
  ...
  },
  {
    ...
    icon: Rocket,
    emoji: "🚀",
    title: "Device Deployment & Integration",
    description:
      "We install and configure IoT sensors, edge gateways, and connectivity modules — integrating them with your existing systems and network infrastructure.",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    emoji: "🛡️",
    title: "Platform Configuration & Testing",
    description:
      "End-to-end platform setup including data pipelines, dashboards, alerts, and security testing to ensure reliable and secure data flow from device to cloud.",
  ...
  },
  {
    ...
    description:
      "24/7 device health monitoring, firmware updates, performance tuning, and data analytics optimization to maximize the value of your IoT investment.",
    image: "/images/fleet/fleet15.png",
  },
];

export function IoTHowItWorksSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            From Assessment to Optimization in 5 Steps
          </h2>
          ...
          >
            We handle everything — from IoT readiness assessment to continuous
            device monitoring and platform optimization.
          </p>
        </div>
