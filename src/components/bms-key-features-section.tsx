...
const row1Features: Feature[] = [
  {
    ...
    description:
      "Single-pane-of-glass view for all building systems — HVAC, lighting, fire, and security — with real-time status and remote override.",
  },
  {
    id: 2,
    icon: Zap,
    ...
    description:
      "AI-driven algorithms that analyze consumption patterns and automatically adjust systems to minimize energy waste.",
  },
  {
    id: 3,
    icon: Settings,
    ...
    description:
      "Sensor-driven diagnostics that detect anomalies early, schedule maintenance proactively, and prevent costly breakdowns.",
  },
  {
    id: 4,
    icon: ShieldCheck,
    ...
    description:
      "Unified fire, smoke, gas detection, and emergency protocols with automated alerts and compliance logging.",
  },
];
...
const row2Features: Feature[] = [
  {
    ...
    description:
      "People-counting and zone detection that adjusts HVAC, lighting, and ventilation based on real-time occupancy levels.",
  },
  {
    id: 6,
    icon: BarChart3,
    ...
    description:
      "Live KPIs, historical trend analysis, energy benchmarking, and automated reporting for facility managers.",
  },
  {
    id: 7,
    icon: Smartphone,
    title: "Remote Access & Mobile Control",
    description:
      "Full BMS control from any device — adjust setpoints, view alarms, and manage schedules on the go.",
  },
];
...
export function BMSKeyFeaturesSection() {
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16">
          ...
          >
            Everything you need to monitor, optimize, and control your building
            systems — from a single intelligent platform.
          </p>
        </div>
