...
export function FleetLaunchSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-white py-12 md:py-16 lg:py-24">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {/* Card 1 — Fleet Tracking */}
          <div
            data-card
            className="flex flex-row items-center gap-5 md:gap-6 lg:gap-8 rounded-2xl md:rounded-3xl p-5 md:p-7 lg:p-8 opacity-0"
            style={{
              background: "#ffffff",
